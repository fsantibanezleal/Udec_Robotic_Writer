<#
.SYNOPSIS
    Build Udec_Robotic_Writer as a standalone executable using PyInstaller.
...
.DESCRIPTION
    ...
    5. Output: dist/Udec_Robotic_Writer/Udec_Robotic_Writer.exe
